...
class TestDSLPipeline:
    def test_command_component_create(self, client: MLClient, randstr: Callable[[], str]) -> None:
        component_yaml = components_dir / "helloworld_component.yml"
        component_func1 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
        component_func2 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
    ...
    def test_pipeline_job_create_with_resolve_reuse(self, client: MLClient, randstr: Callable[[], str]) -> None:
        component_yaml = components_dir / "helloworld_component.yml"
    ...
    def test_command_component_create_with_output(self, client: MLClient, randstr: Callable[[], str]) -> None:
        component_yaml = components_dir / "helloworld_component.yml"
        component_func1 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
        component_func2 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
    ...
    def test_distribution_components(self, client: MLClient, randstr: Callable[[], str]) -> None:
    ...
    def test_component_with_binding(self, client: MLClient, randstr: Callable[[], str]):
    ...
    def test_command_function(self, randstr: Callable[[], str], client: MLClient):
        hello_world_component_yaml = str(components_dir / "helloworld_component.yml")
        hello_world_component_func = load_component(source=hello_world_component_yaml)
    ...
    def test_command_with_optional_inputs(self, randstr: Callable[[], str], client: MLClient):
        hello_world_component_yaml = str(components_dir / "helloworld_component_with_optional_inputs.yml")
        hello_world_component_func = load_component(source=hello_world_component_yaml)
        command_func = command(
            name=f"test_optional_input_component_{randstr()}",
        ...
        @dsl.pipeline(
            name=f"test_optional_input_component_pipeline_{randstr()}",
    ...
    def test_spark_with_optional_inputs(self, randstr: Callable[[], str], client: MLClient):
    ...
    def test_command_by_pass(self, randstr: Callable[[], str], client: MLClient):
        hello_world_component_yaml = str(components_dir / "helloworld_component.yml")
    ...
    def test_pipeline_reuse(self, client: MLClient, randstr: Callable[[], str], randint: Callable) -> None:
        component_yaml = components_dir / "helloworld_component.yml"
        component_func1 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
        component_func2 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
    ...
    def test_anon_component_in_pipeline(
        self, client: MLClient, randstr: Callable[[], str], hello_world_component: Component
    ) -> None:
    ...
    def test_pipeline_force_rerun(self, client: MLClient, randstr: Callable[[], str]) -> None:
        component_yaml = components_dir / "helloworld_component.yml"
        component_func1 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
        component_func2 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
    ...
    def test_parallel_components_with_tabular_input(self, client: MLClient, randstr: Callable[[], str]) -> None:
    ...
    def test_parallel_components_with_file_input(self, client: MLClient, randstr: Callable[[], str]) -> None:
    ...
    def test_parallel_job(self, randstr: Callable[[], str], client: MLClient):
        environment = "AzureML-sklearn-0.24-ubuntu18.04-py37-cpu:5"
        inputs = {
            "job_data_path": Input(
                type=AssetTypes.MLTABLE,
    ...
    def test_get_child_job(self, client: MLClient, randstr: Callable[[], str]) -> None:
        component_yaml = components_dir / "helloworld_component.yml"
        component_func1 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
        component_func2 = load_component(source=component_yaml, params_override=[{"name": randstr()}])
    ...
    @pytest.mark.skip("Skip for compute resource not ready.")
    def test_spark_components(self, client: MLClient, randstr: Callable[[], str]) -> None:
