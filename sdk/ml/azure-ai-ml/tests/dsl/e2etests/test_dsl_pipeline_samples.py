...
class TestDSLPipelineSamples:
    ...
    def test_e2e_registered_components(
        ...
        from dsl_pipeline.e2e_registered_components.pipeline import generate_dsl_pipeline as e2e_registered_components
    ...
    def test_env_public_docker_image(self, client: MLClient) -> None:
        from dsl_pipeline.env_public_docker_image.pipeline import generate_dsl_pipeline as env_public_docker_image
    ...
    def test_nyc_taxi_data_regression(self, client: MLClient) -> None:
        from dsl_pipeline.nyc_taxi_data_regression.pipeline import generate_dsl_pipeline as nyc_taxi_data_regression
    ...
    def test_e2e_inline_components(self, client: MLClient) -> None:
        from dsl_pipeline.e2e_inline_components.pipeline import generate_dsl_pipeline as e2e_inline_components
    ...
    def test_parallel_components(self, client: MLClient) -> None:
        from dsl_pipeline.parallel_component.pipeline import generate_dsl_pipeline as pipeline_with_parallel_components
    ...
    def test_pipeline_with_pipeline_component(self, client: MLClient) -> None:
        from dsl_pipeline.pipeline_with_pipeline_component.pipeline import (
    ...
    def test_pipeline_with_data_as_inputs_for_pipeline_component(self, client: MLClient) -> None:
        from dsl_pipeline.pipeline_with_pipeline_component.pipeline_with_data_as_input import (
            generate_dsl_pipeline as pipeline_with_pipeline_component,
        )
    ...
    def test_spark_job_in_pipeline(self, client: MLClient) -> None:
        from dsl_pipeline.spark_job_in_pipeline.pipeline import generate_dsl_pipeline_from_yaml as spark_job_in_pipeline
    ...
    def test_spark_job_with_builder_in_pipeline(self, client: MLClient) -> None:
        from dsl_pipeline.spark_job_in_pipeline.pipeline import (
    ...
    def test_spark_job_with_multiple_node_in_pipeline(self, client: MLClient) -> None:
        from dsl_pipeline.spark_job_in_pipeline.kmeans_sample.pipeline import (
